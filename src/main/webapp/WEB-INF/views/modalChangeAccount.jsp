...
<form:form modelAttribute="user" role="form" method="POST" id="accountForm" action="${pageContext.request.contextPath}/myaccount/changed/account">
<!-- Modal -->
	    ...
	    <div class="modal-content modal-backcolor-content">
	      ...
	      <div class="modal-body modal-backcolor-body">
	      	...
	      	<table class="table">
				...
				<tr> 
				 	<th class="form-group col-md-8">
						<label for="name">nazwa: ${user.name} </label>
						<form:input type="hidden"  id="name"  path="name"  class="form-control"  />
					</th>
				</tr>
				<tr> 
				 	<th class="form-group col-md-8">
				...
				<tr> 
				 	<th class="form-group col-md-8">
						<form:input type="hidden" id="password"  path="password"  class="form-control" />
					</th>
				</tr>									
